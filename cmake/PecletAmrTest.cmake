# ---- Test registration: ONE place for the skip protocol and the labels (suite/docs/QUALITY_PLAN.md
#      §3.D; the protocol peclet-core's cmake/PecletCoreTest.cmake established, carried over with the
#      AMR battery on 2026-09-10).
#  * SKIP_RETURN_CODE 77: a binary that cannot run in this configuration exits 77
#    (tests/test_util.hpp kSkipExitCode) and ctest reports it "Not Run (skipped)" — never Passed.
#    `ctest -N` therefore always lists the full battery, whatever the configuration.
...
#    `python` on the Python ctests.
function(peclet_amr_add_test name target)
...
function(peclet_amr_add_mpi_test name target np)
