# Pin the MPI launcher to the MPI compiler's own prefix (the protocol of peclet-core's
# cmake/PecletCorePinMpiexec.cmake, carried over with the AMR battery on 2026-09-10).
#
...
# multi-rank tests "pass" without ever communicating (core's Python tree carried exactly this until
...
# -DPECLET_AMR_PIN_MPIEXEC=OFF and set MPIEXEC_EXECUTABLE themselves.
option(PECLET_AMR_PIN_MPIEXEC "Pin MPIEXEC_EXECUTABLE to the MPI compiler's prefix" ON)
if(PECLET_AMR_PIN_MPIEXEC AND MPI_CXX_COMPILER)
  ...
  if(_mpi_launcher AND NOT _mpi_launcher STREQUAL "${MPIEXEC_EXECUTABLE}")
    message(STATUS "peclet-amr: MPIEXEC_EXECUTABLE was '${MPIEXEC_EXECUTABLE}' — "
